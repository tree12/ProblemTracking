...
export class LoginClient {
    ...
    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(API_BASE_URL) baseUrl?: string) {
        this.http = http;
        this.baseUrl = baseUrl ?? "https://localhost:44367";
    }
...
export class MachineClient {
    ...
    getInvestigateStep(machineId: number | undefined): Observable<InvestigateStepViewModel[]> {
        ...
        if (machineId === null)
            throw new globalThis.Error("The parameter 'machineId' cannot be null.");
...
export class UserViewModel extends BaseViewModelOfString implements IUserViewModel {
    ...
    static override fromJS(data: any, _mappings?: any): UserViewModel | null {
        data = typeof data === 'object' ? data : {};
...
export class MachineViewModel extends BaseViewModelOfInteger implements IMachineViewModel {
    ...
    static override fromJS(data: any, _mappings?: any): MachineViewModel | null {
        data = typeof data === 'object' ? data : {};
    ...
    override toJSON(data?: any) {
        ...
        if (Array.isArray(this.investigateSteps)) {
            ...
            for (let item of this.investigateSteps)
                data["investigateSteps"].push(item ? item.toJSON() : undefined as any);
        }
        super.toJSON(data);
        return data;
    }
...
export class InvestigateStepViewModel extends BaseViewModelOfInteger implements IInvestigateStepViewModel {
    ...
    override init(_data?: any, _mappings?: any) {
        ...
        if (_data) {
            ...
            this.machine = _data["machine"] ? MachineViewModel.fromJS(_data["machine"], _mappings) : undefined as any;
        }
    }

    static override fromJS(data: any, _mappings?: any): InvestigateStepViewModel | null {
        data = typeof data === 'object' ? data : {};
    ...
    override toJSON(data?: any) {
        ...
        data["machine"] = this.machine ? this.machine.toJSON() : undefined as any;
        super.toJSON(data);
        return data;
    }
}
...
export class ProblemViewModel extends BaseViewModelOfInteger implements IProblemViewModel {
    ...
    override init(_data?: any, _mappings?: any) {
        ...
        if (_data) {
            ...
            this.user = _data["user"] ? UserViewModel.fromJS(_data["user"], _mappings) : undefined as any;
            this.machine = _data["machine"] ? MachineViewModel.fromJS(_data["machine"], _mappings) : undefined as any;
    ...
    static override fromJS(data: any, _mappings?: any): ProblemViewModel | null {
        data = typeof data === 'object' ? data : {};
...
export class ProblemInvestigateViewModel extends BaseViewModelOfString implements IProblemInvestigateViewModel {
    ...
    override init(_data?: any, _mappings?: any) {
        super.init(_data);
        if (_data) {
            this.problem = _data["problem"] ? ProblemViewModel.fromJS(_data["problem"], _mappings) : undefined as any;
            this.stepToSolved = _data["stepToSolved"] ? InvestigateStepViewModel.fromJS(_data["stepToSolved"], _mappings) : undefined as any;
            this.solveStatus = _data["solveStatus"];
            this.picture = _data["picture"];
        }
    }

    static override fromJS(data: any, _mappings?: any): ProblemInvestigateViewModel | null {
        data = typeof data === 'object' ? data : {};
    ...
    override toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["problem"] = this.problem ? this.problem.toJSON() : undefined as any;
        data["stepToSolved"] = this.stepToSolved ? this.stepToSolved.toJSON() : undefined as any;
        data["solveStatus"] = this.solveStatus;
